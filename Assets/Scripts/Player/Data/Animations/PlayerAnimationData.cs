...
public class PlayerAnimationData
{
    ...
    [SerializeField] private string fallRollingParameterName = "isFallingRoll";
    ...
    public int FallRollingParameterHash { get; private set; }
    ...
    public void Init()
    {
        ...
        FallRollingParameterHash = Animator.StringToHash(fallRollingParameterName);
