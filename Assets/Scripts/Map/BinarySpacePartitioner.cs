...
public class BinarySpacePartitioner : MonoBehaviour
{
    ...
    private void SplitTheSpace(Node currentNode, List<RoomNode> listToReturn, int roomLengthMin, int roomWidthMin,
    ...
    private Line GetLineDividingSpace(Vector2Int bottomLeftAreaCorner, Vector2Int topRightAreaCorner, int roomWidthMin,
        int roomLengthMin)
    {
