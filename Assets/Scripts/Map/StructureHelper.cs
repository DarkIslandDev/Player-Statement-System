...
public static class StructureHelper
{
    public static List<Node> TraverseGraphToExtractLowestLeafes(Node parentNode)
    {
        ...
        foreach (Node child in parentNode.ChildrenNodeList) nodesToCheck.Enqueue(child);
    ...
    public static Vector2Int CalculateMiddlePoint(Vector2Int v1, Vector2Int v2)
    {
        ...
        Vector2Int tempVector = sum / 2;
        
        return new Vector2Int(tempVector.x, tempVector.y);
    }
}